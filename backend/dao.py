...
from backend.models import Category, CustomerCardUsage, LoyalCustomer, Order, OrderStatus, Product, Receipt, ReceiptDetails, Room, RoomType, Session, SessionStatus, User, Job, UserRole
